...
import { ARTHistoryModel, Customer, TX_ML } from '../../models/customer';
...
const CreateTX_ML_ARTFormModal: React.FC<Props> = (props) => {
  ...
  return (
    <Modal open={Boolean(formType === 9)} onClose={onClose}>
      <Modal.Content>
...
export default CreateTX_ML_ARTFormModal;
